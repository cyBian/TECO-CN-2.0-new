...
!      CN_leaf,CN_wood,CN_root,CN_fine,CN_coarse,CN_micr,CN_slowC,CN_pass
	  ...
	  real N_leaf,N_wood,N_root,N_npp,N_deficit,N_immob
      real N_LF,N_WF,N_RF
...
!	  open(67,file="kexi.csv")
      do isite=1,No_site  ! run model site by site
          ...
          read(10,*,IOSTAT=istat1)site,vegtype,climfile,out_h,   !istat1=0读取正常;>0读取错误；<0表示文件终了
...
!         skip 2 lines of input met data file
          read(11,'(a160)') commts
          read(11,'(a160)') commts
11        format(a132)                                  !  Du: Width of output character 132 btyes_字符宽
12        format(a202)
13        format(a235)
...
!              hour_data(m)=hour_data(m)+1
          ...
          write(*,*)"forcing",lines,yr_data,inputstep  !Du: displayed on the screen_显示
...
!Xia: for diagnosing  
           write(105,'(a250)')"QNminer,N_miner,N_deposit,N_uptake,
     &N_immob"                                                      
!	     
